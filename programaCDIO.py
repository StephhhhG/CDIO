...
#------------------------------Vamos a capturar el rostro-----------------------------------------------------
    ...
    if usuario_login+".jpg" in im_archivos:   #Comparamos los archivos con el que nos interesa
        ...
        if similitud >= 0.98:
            ...
            #Aca se llama la funcion que ejecuta el sistema para que mueva motobomba y aspersores
...
def pantalla_principal():
    ...
    pantalla.title("CAMF BETA")       #Asignamos el titulo de la pantalla
    Label(text = "INICIO CAPSULA", bg = "gray", width = "300", height = "2", font = ("Verdana", 13)).pack() #Asignamos caracteristicas de la ventana
...
#----------------------------Funcion de administrar sistema----------------------------------------------

def sistema():
    global pantalla3

    pantalla3 = Toplevel(pantalla)
    pantalla2.title("Sistema")
    pantalla3.geometry("300x250")   #Creamos la ventana
    Label(pantalla3, text = "El sistema esta en Proceso").pack()
    Label(pantalla3, text = "Aguarde un momento").pack()
    Label(pantalla3, text = "").pack()  #Dejamos un poco de espacio
